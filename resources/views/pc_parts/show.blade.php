...
<div class="card-body">
    <div class="card-body">
        ...
        <p class="card-text">RAM : {{ $pc_part->rams->threads}} <a href=<a href="{{ route('show.ram.details', $pc_part->rams->id) }}"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i>Specifications</button></a></p>
        <p class="card-text">POWER SUPPLY : {{ $pc_part->power_supplies->name}} <a href=<a href="{{ route('show.power_supply.details', $pc_part->power_supplies->id) }}"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i>Specifications</button></a></p>
        <p class="card-text">CPU COOLER : {{ $pc_part->cpu_coolers->name}} <a href=<a href="{{ route('show.cpu_cooler.details', $pc_part->cpu_coolers->id) }}"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i>Specifications</button></a></p>
