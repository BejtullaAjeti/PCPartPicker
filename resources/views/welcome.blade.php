...
@section('content')
    ...
    <div class="container pt-5 min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 text-white">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                @else
                    <div>
                        <p style="color: #1a202c">Please <a href="{{ url('/login') }}">login</a> to build a PC.</p>
                    </div>
                @endif
                <br>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="{{ asset('img/image1.png') }}" alt="Image 1" class="img-fluid">
                <img src="{{ asset('img/image2.jpg') }}" alt="Image 2" class="img-fluid">
            </div>
        </div>
    </div>
@endsection
